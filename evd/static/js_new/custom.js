...
/* ----- added for our team ---- */
 $(document).ready(function() {
    $('.tab_style').on( 'click', 'button', function( event ) {
        var item_selected  = $(this).attr('data');
        $('.tab_style').find('button').removeClass('active');
        $(this).addClass('active');
        if(item_selected == 'trustee'){
            $("#trustees").removeClass("hidden");
            $("#execution").addClass("hidden");
            $("#class_adm").addClass("hidden");
        }
        else if(item_selected == 'exe'){
            $("#trustees").addClass("hidden");
            $("#execution").removeClass("hidden");
            $("#class_adm").addClass("hidden");
        }else{
            $("#class_adm").removeClass("hidden");
            $("#trustees").addClass("hidden");
            $("#execution").addClass("hidden");
        }
...
//added
   ...
   if(filterValue=='.mission'){
        $('.vision').addClass('hidden');
        $('.values').addClass('hidden');
        $('.mission').removeClass('hidden');
   }
   else if(filterValue=='.vision'){
